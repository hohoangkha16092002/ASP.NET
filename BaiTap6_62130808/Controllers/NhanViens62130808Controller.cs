...
using BaiTap6_62130808.Models;

namespace BaiTap6_62130808.Controllers
{
    public class NhanViens62130808Controller : Controller
    {
        private QLNV_62130808Entities db = new QLNV_62130808Entities();
        ...
        public ActionResult TimKiem(string maNV)
        {
            ...
            var nhanViens = db.NhanViens.Where(abc => abc.MaNV.Contains(maNV)); //Tìm gần chính xác
            return View(nhanViens.ToList());
        }
        [HttpGet]

        public ActionResult TimKiem_62130808(string maNV = "", string hoTen = "", string gioiTinh = "", string luongMin = "", string luongMax = "", string diaChi = "", string maPB = "")
        {
        ...
        // GET: NhanViens62130808/Details/5
        ...
        // GET: NhanViens62130808/Delete/5
        ...
        // POST: NhanViens62130808/Delete/5
